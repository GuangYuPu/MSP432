...
//显示一个浮点数
void OLED_ShowFloat(uint8_t x, uint8_t y, float num, uint8_t len_int, uint8_t len_point, uint8_t sizey)
{
    ...
    case /* constant-expression */1:
      /* code */
      num_point = (uint32_t)(num - num_int)*10;
    case /* constant-expression */2:
      /* code */
      num_point = (uint32_t)(num - num_int)*100;
    case /* constant-expression */3:
      /* code */
      num_point = (uint32_t)(num - num_int)*1000;
    case /* constant-expression */4:
      /* code */
      num_point = (uint32_t)(num - num_int)*10000;
      break;
    default:
      break;
    }
    OLED_ShowNum(x,y,num_int,len_int,sizey);
    OLED_ShowString(x+len_int*6,y,string,sizey);
    OLED_ShowNum(x+len_int*6+6,y,num_point,len_point,sizey);
}
//显示汉字
